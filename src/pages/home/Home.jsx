    ...
    return (  
        <div>
          ...
          <div className="empty">
            ...
            >
               <Tab className='human' icon={<img src={human} alt="icon" width={30} />} label="Create an Account"  {...a11yProps(0)} />
               <Tab className='human' icon={<img src={calendar} alt="icon" width={30} />} label="Join an Event" {...a11yProps(1)} />
               <Tab className='human' icon={<img src={checklist} alt="icon" width={30} />} label="Submit Requirements" {...a11yProps(2)} />
               <Tab className='human' icon={<img src={list} alt="icon" width={30} />} label="Get Shortlisted" {...a11yProps(3)} />
               <Tab className='human' icon={<img src={votebox} alt="icon" width={30} />} label="Get the Highest Votes" {...a11yProps(4)} />
